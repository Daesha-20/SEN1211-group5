...
to consume-bottles
  ask families [
    set f-consumption-small-bottles random 11
  ]

  ask couples [
    set c-consumption-small-bottles random 9
  ]

  ask singles [
    set s-consumption-small-bottles random 6
  ]
end
    ...
    ifelse policy-of-recycling-campaign = "yes"[
      ask singles[
        ifelse s-acceptance-of-campaign = 1 [ ;yes
          ...
          ;if f-base-knowledge-level high
...
to calculate-recycle-bottles
  ask recycling-companies [
    ifelse num-recieve-bottles > recycling-capacity [
...
to calculate-rate-recycling ;per tick
