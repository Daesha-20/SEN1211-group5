...
to setup
  ...
  ifelse model-version = "yes-policy" [
    ...
    ask recycling-companies [
      ...
      ;set R-capacity-incease R-capacity + recycling-investment * recycling-changing-ratio
      set recycling-capacity R-capacity + recycling-investment * recycling-changing-ratio
      ;let recycling-changing-ratio [5 1000]
    ]

    ask collection-points [
      set collection-investment total-budget * fraction-of-collection
      ;set C-capacity-incease C-capacity + collection-investment * collection-changing-ratio
      set collection-capacity C-capacity + collection-investment * collection-changing-ratio
...
to move
  rt random 10 ;turn right randomly
  lt random 10 ;turn left randomly
  fd 5
end
...
to consume-bottles
  ask families [
    set f-consumption-small-bottles random 11; randomization of small bottle consumptiom, number need to be reset for data analysis
    ;set fam-consume lput f-consumption-small-bottles fam-consume
    ;print fam-consume
  ]

  ask couples [
    set c-consumption-small-bottles random 9; randomization of small bottle consumptiom, number need to be reset for data analysis
    ;set cpl-consume lput c-consumption-small-bottles cpl-consume
  ]

  ask singles [
    set s-consumption-small-bottles random 6; randomization of small bottle consumptiom, number need to be reset for data analysis
...
to collect-bottles  ; wolf procedure
  ...
  ask couples [
    return-bottles-couples
  ]

  ask singles [
    return-bottles-singles
  ]

end


to return-bottles-families

    ifelse policy-of-recycling-campaign = "yes"[
      ask families[
        ifelse f-acceptance-of-campaign = 1 [ ;yes
          ifelse f-base-knowledge-level = 0 [ ;low
    ...
    set num-return-bottles-families f-consumption-small-bottles * f-increase-knowledge
      ;sum [f-consumption-small-bottles * f-increase-knowledge ] of families
      ]
   ]
  ;if policy-of-recycling-campaign = "no"[
  [
  ask families[
        set num-return-bottles-families f-consumption-small-bottles * f-base-knowledge
      ;sum [ f-consumption-small-bottles * f-base-knowledge ] of families
      ]
    ]
  ;print num-return-bottles-families

end

to return-bottles-couples

    ifelse policy-of-recycling-campaign = "yes"[
      ask couples[
        ifelse c-acceptance-of-campaign = 1 [ ;yes
          ifelse c-base-knowledge-level = 0 [ ;low
            set c-knowledge-increase-perc random-float 0.4 + 0.1
       ...
       ;if c-acceptance-of-campaign = 0 [ ;no
      [ set c-increase-knowledge c-base-knowledge
      ]

    set num-return-bottles-couples c-consumption-small-bottles * c-increase-knowledge
      ;sum [c-consumption-small-bottles * c-increase-knowledge ] of couples
      ]
   ]
  ;if policy-of-recycling-campaign = "no"[
  [
  ask couples[
        set num-return-bottles-couples c-consumption-small-bottles * c-base-knowledge
      ;sum [ c-consumption-small-bottles * c-base-knowledge ] of couples
      ]
    ]
  ;print num-return-bottles-couples

end

to return-bottles-singles

    ifelse policy-of-recycling-campaign = "yes"[
      ask singles[
        ifelse s-acceptance-of-campaign = 1 [ ;yes
          ifelse s-base-knowledge-level = 0 [ ;low
            set s-knowledge-increase-perc random-float 0.4 + 0.1
       ...
       ;if s-acceptance-of-campaign = 0 [ ;no
      [ set s-increase-knowledge s-base-knowledge
      ]

    set num-return-bottles-singles s-consumption-small-bottles * s-increase-knowledge
      ;sum [s-consumption-small-bottles * s-increase-knowledge ] of singles
      ]
   ]
  ;if policy-of-recycling-campaign = "no"[
  [
  ask singles[
        set num-return-bottles-singles s-consumption-small-bottles * s-base-knowledge
      ;sum [ s-consumption-small-bottles * s-base-knowledge ] of singles
      ]
    ]
  ;print num-return-bottles-singles
...
to calculate-collection-bottles
  ask collection-points [
    set num-return-bottles sum [num-return-bottles-families] of families + sum [num-return-bottles-couples] of couples + sum [num-return-bottles-singles] of singles
...
to recycle-bottles
  ask recycling-companies [
    set num-recieve-bottles num-collection-bottles * (1 - 0.01)  ;manually setup loss-rate, loss during transportation and unexpected accidents
  ]
end
...
to calculate-rate-recycling
   ...
   ifelse num-recycle-bottles = 0 [
      set rate-recycling 0
      ]
    [set rate-recycling num-recycle-bottles / (sum [f-consumption-small-bottles] of families + sum [c-consumption-small-bottles] of couples + sum [s-consumption-small-bottles] of singles)
      ]
...
to show-plot
 export-all-plots "D:/Master/course/S2/Q2/agent based modeling/final project/model/github/SEN1211-group5/plot/plots.csv"
end
...
"" ""
PENS
"num-recycle" 1.0 0 -15302303 true "" "ask recycling-companies [plot num-recycle-bottles]"
"num - collect" 1.0 0 -6565750 true "" "ask collection-points [plot num-collection-bottles]"
...
"" ""
PENS
"rate-recycling" 1.0 0 -15040220 true "" "plot rate-recycling"
...
"" ""
PENS
"total-collection" 1.0 0 -3844592 true "" "plot total-collection"
"total-recycle" 1.0 0 -14454117 true "" "plot total-collection"

@#$#@#$#@
## WHAT IS IT?

The model displays the deposit refund scheme in a municipality with 100 people, 5 collection points and 2 recycling companies.

## HOW IT WORKS

The municipality has a policy in which there is a budget that can be allocated to a recycling campaign, expansion of collection points, or improving recycling companies technology. The budget being enacted affects the consumer behaviour in returning bottles or the capacity of bottles able to be collected or recycled.

## HOW TO USE IT

To use the model the user must decide whether to enact the policy or not. If there is an allocation of budget then there should be a distribution of budget between the three options (recycling campaign, expansion of collection points, or improving recycling companies technology).


## THINGS TO NOTICE

When running the model observe the graphs to the right of the screen.

## THINGS TO TRY

Try enabling and disabling the policy. Play with the different parameters on the left hand of the screen in order to enable different scenarios. 


## EXTENDING THE MODEL

Code can be added to enable different technologies in the recycling companies so that there is more unpredictability.
...
@#$#@#$#@
<experiments>
  <experiment name="Yes_50% knowladge" repetitions="10" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="520"/>
    <metric>total-collection</metric>
    <metric>total-recycle</metric>
    <metric>rate-recycling</metric>
    <enumeratedValueSet variable="initial-perc-singles">
      <value value="0.5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-num-collection-points">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="show-bottles?">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="fraction-of-collection">
      <value value="0.25"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="model-version">
      <value value="&quot;yes-policy&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="population">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-perc-families">
      <value value="0.2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="fraction-of-technology">
      <value value="0.25"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="total-budget">
      <value value="1000"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="fraction-of-campaign">
      <value value="0.5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="recycling-changing-ratio">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-perc-couples">
      <value value="0.3"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="max-bottles">
      <value value="10000000"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-num-recycling-companies">
      <value value="2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="C-capacity">
      <value value="1000"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="collection-changing-ratio">
      <value value="2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="R-capacity">
      <value value="1000"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="Yes_50% collection" repetitions="10" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="520"/>
    <metric>total-collection</metric>
  ...
  <experiment name="Yes_50% recycling" repetitions="10" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="520"/>
    <metric>total-collection</metric>
  ...
  <experiment name="Yes_33% each" repetitions="10" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="520"/>
    <metric>total-collection</metric>
  ...
  <experiment name="no-policy" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="520"/>
    <metric>total-collection</metric>
