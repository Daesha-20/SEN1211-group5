...
"" ""
PENS
"total-recycle" 1.0 0 -4079321 true "" "ask recycling-companies [plot total-recycle]"
"total-collection" 1.0 0 -14454117 true "" "ask collection-points [plot total-collection]"
...
@#$#@#$#@
<experiments>
  <experiment name="50% compaign" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="260"/>
